...
public class PlayerController : MonoBehaviour
{
    ...
    private void FireRight()
    {
        if (f_currentFireTimerRight <= 0)
        {
            ...
            {
                GameObject _go_bullet = PoolManager.x.SpawnObject(go_bulletPrefabRight, go_firePointRight.transform.position, c_cam.transform.rotation);
    ...
    private void FireLeft()
    {
        if (f_currentFireTimerLeft <= 0)
        {
            ...
            {
                GameObject _go_bullet = PoolManager.x.SpawnObject(go_bulletPrefabLeft, go_firePointLeft.transform.position, c_cam.transform.rotation);
