...
public class CameraRespectWalls : MonoBehaviour
{
    ...
    {
        v_currentOffset += new Vector3(Random.Range(-_f_severity, _f_severity), Random.Range(_b_onlyUp ? 0 : -_f_severity, _f_severity), Random.Range(-_f_severity, _f_severity));        
