...
public struct OldPool
{
    ...
    /// </summary>
    private OldIPoolable[] IA_objectsInPool;
    ...
    private int GetAvailabeIndex()
    {
        ...
        foreach (OldIPoolable active in IA_objectsInPool)
            if (active.GetInPool())
            {
    ...
    public void ResizeArray()
    {
        ...
        OldIPoolable[] newPool = new OldIPoolable[i_size];
    ...
    /// </param>
    public void ResizeArray(OldIPoolable newObject)
    {
        ...
        List<OldIPoolable> tempList = new List<OldIPoolable>(newPool);
    ...
    /// new object
    /// </param>
    public void AddAtIndex(int _i_index, OldIPoolable _I_delta)
    {
        if (_i_index < i_size)
